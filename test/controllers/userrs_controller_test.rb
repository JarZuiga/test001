...
class UserrsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create userr" do
    assert_difference("Userr.count") do
      post userrs_url, params: { userr: { age: @userr.age, email: @userr.email, name: @userr.name } }
    end
  ...
  test "should update userr" do
    patch userr_url(@userr), params: { userr: { age: @userr.age, email: @userr.email, name: @userr.name } }
